...
async def banned_page() -> None:
    ...
    with ui.column().classes("absolute-center items-center"):
        ...
        ui.label("Your account has been suspended.").classes(
            "text-2xl font-bold mt-4"
        ).props('data-testid="suspension-message"')
        ui.label("Contact your instructor.").classes("text-lg text-grey-7 mt-2").props(
            'data-testid="suspension-contact"'
        )
