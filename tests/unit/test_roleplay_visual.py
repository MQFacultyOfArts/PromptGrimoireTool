...
class TestAvatarParameter:
    ...
    _create_chat_message uses text_html=True so Quasar handles bubble
    structure natively. The text is converted from markdown emphasis to
    HTML <em> tags before passing to ui.chat_message.
    """
    ...
    def test_avatar_defaults_to_none(self, mock_ui: MagicMock) -> None:
        """Omitting avatar passes avatar=None."""
        from promptgrimoire.pages.roleplay import _create_chat_message
