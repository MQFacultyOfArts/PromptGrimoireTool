...
class TestLoadtestCrdtTagValidity:
    ...
    async def test_highlight_tags_are_valid_uuids(self) -> None:
        ...
        assert len(highlights) >= 2, (
            "Expected at least 2 highlights from build_crdt_state"
        )
    ...
    async def test_highlight_tag_uuids_exist_in_database(self) -> None:
        ...
        # Fetch all Tag IDs for this workspace from the database
        ...
        # Every highlight tag UUID must exist in the database
        highlight_tag_ids = {hl["tag"] for hl in highlights}
