...
def _stream_output(
    ...
    """Stream pytest output to stdout and log file."""
...
def _run_pytest(
    ...
    # Panels for interactive terminals; piped output (e.g. Claude Code)
    # gets a one-line header to minimise token usage.
    # Note: rtk is NOT used for pytest — its "failures only" filter hides
    # passing results, making Claude think tests didn't collect.
    ...
    with log_path.open("w") as log_file:
        ...
        exit_code = _stream_output(process, log_file)
