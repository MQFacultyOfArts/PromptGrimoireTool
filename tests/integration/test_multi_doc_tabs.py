...
Traceability:
- Plan: phase_07.md Task 2 (multi-doc-tabs-186-plan-a)
...
async def _setup_workspace_with_docs(
    ...
    for title in doc_titles:
        await _add_template_document(template_ws_id, title=title)

    ws_id, _ = await _clone_workspace(activity_id, user_id)
    return ws_id
