"""Legacy CLI entry points — E2E test commands.

These entry points are still registered as ``[project.scripts]`` in
``pyproject.toml`` and will be migrated to the ``cli/`` package in Phase 5.
"""
