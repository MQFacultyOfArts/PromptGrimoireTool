...
Requires short idle timeouts to be set BEFORE the E2E server starts:

    IDLE__TIMEOUT_SECONDS=5 IDLE__WARNING_SECONDS=2 \
        uv run grimoire e2e slow -k test_idle_tab_eviction

Tests are skipped gracefully when the short values aren't configured.
...
class TestIdleTimeout:
    ...
    def test_idle_timeout_navigates_to_paused(self, authenticated_page: Page) -> None:
...
class TestWarningModal:
    ...
    def test_warning_modal_appears_before_eviction(
    ...
    def test_stay_active_dismisses_and_resets(self, authenticated_page: Page) -> None:
    ...
    def test_any_click_dismisses_modal(self, authenticated_page: Page) -> None:
    ...
    def test_interaction_during_warning_resets_timer(
        self, authenticated_page: Page
    ) -> None:
...
class TestVisibilityChange:
    ...
    def test_refocus_past_timeout_evicts_immediately(
        self, authenticated_page: Page
    ) -> None:
    ...
    def test_refocus_in_warning_window_shows_modal(
        self, authenticated_page: Page
    ) -> None:
    ...
    def test_refocus_below_threshold_resets_timer(
        self, authenticated_page: Page
    ) -> None:
...
class TestResumeFlow:
    ...
    def test_resume_returns_to_original_page(self, authenticated_page: Page) -> None:
